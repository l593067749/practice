package com.practice.springboot.p14.config;
...
//     UserInfo userInfo = userInfoService.findByUsername(username)
    ...
    authorizationInfo.addRole("admin");
     ...
     authorizationInfo.addStringPermission("/thmleaf/:GET");
        //异常类的处理
     authorizationInfo.addStringPermission("/thmleaf/error:GET");
     authorizationInfo.addStringPermission("/thmleaf/error_json:GET");
