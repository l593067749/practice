package com.practice.springboot.p11.config;

import com.practice.springboot.p11.common.filter.MyURLPermissionFilter;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //配置记住我或认证通过可以访问的地址
        //filterChainDefinitionMap.put("/thmleaf/", "user");
        ...
        filterChainDefinitionMap.put("/thmleaf/**", "permission");
