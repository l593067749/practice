...
@MapperScan("com.practice.springboot.p03")
public class Application {
	...
	public PageInfo<User> queryAll(@RequestParam(value = "pageNum", required = false, defaultValue="1") Integer pageNum,
		...
		List<User> list = userMapper.queryAll2(new RowBounds(pageNum,pageSize));
		PageInfo<User> pageInfo = new PageInfo<User>(list);
		return  pageInfo;
	}
	@RequestMapping(value = "/queryAllByPage2", method = RequestMethod.GET)
	public PageInfo<User> queryAll2(@RequestParam(value = "pageNum", required = false, defaultValue="1") Integer pageNum,
								   @RequestParam(value = "pageSize", required = false, defaultValue="10") Integer pageSize) {
		PageHelper.startPage(pageNum, pageSize);
		List<User> list = userMapper.findAll();
		PageInfo<User> pageInfo = new PageInfo<User>(list);
	...
	public static void main(String[] args) throws Exception {
		SpringApplication.run(new Object[]{Application.class,PageHelperConfiguration.class}, args);
	}
